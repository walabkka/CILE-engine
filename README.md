...
<sub><b><i>Note: This system has been evaluated using the STARE-HI (Statement on Reporting of Evaluation Studies in Health Informatics) framework. Detailed evaluation of the system architecture and clinical problem context can be found in evaluation_log.md. The clinical logic and architecture were self-directed. AI was utilized as a "pair-programmer" to navigate API structures and refine Python syntax, allowing the primary focus to remain on healthcare informatics and data behavior. Prompt engineering skills are required!</i></b></sub>
----------------------------------------
## Built With
